...
<div id="topic_add_box" class="pageContent">
    <form method="post" action="<?php echo U('IntoHelp/addImages');?>"  class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone);">
        <div class="pageFormContent" layoutH="96">
           ...
           <div class="unit">
               <div style="float: left;">
                   <label style="">右侧图:</label>
               </div>
               <div style="float: left;"> 
                   <div class="general_style" >
                       <?php if(is_array($images)): foreach($images as $key=>$vo): if($vo): ?><div  class="publish_picture_list" id="hq2017">
                           <div class="publish_picture_img"> <img width="200" height="200" src="<?php echo ($vo); ?>" alt=""> </div>
                           <button type="button" class="publish_picture_delet" >删除</button>
                           <input class="state" type="hidden" name="images[]" value="<?php echo ($vo); ?>" />
                        </div><?php endif; endforeach; endif; ?>
                       <div class="btns1" style="float: left;">
                           <div id="images">选择</div>
                       </div>
...
<script type="text/javascript">
    var server = '<?php echo U("intoHelp/oneUpload");?>';
    $(function(){
        // 初始化时间选择
